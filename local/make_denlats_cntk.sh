...
[ -f ./cmd.sh ] && . ./cmd.sh; # This is for the cntk command
...
if [ -z $cntk_model ] ; then cntk_model=$srcdir/cntk.mdl || exit 1; fi
...
cntk_feats="$cn_gpu $cntk_forward_opts featureTransform=$feature_transform"
